...
function resolve(config: DevClawConfig): ResolvedConfig {
  ...
  const workflow: WorkflowConfig = {
    ...
    publishPolicy: config.workflow?.publishPolicy ?? DEFAULT_WORKFLOW.publishPolicy,
    analyzeAfterDays: config.workflow?.analyzeAfterDays ?? DEFAULT_WORKFLOW.analyzeAfterDays,
